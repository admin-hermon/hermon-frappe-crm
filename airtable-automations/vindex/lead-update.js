// Name: Sync lead updates with Vindex Frappe CRM
...
// Hermon Admin (The action must be done as a specific user)
...
try {
    ...
    let response = await fetch(`https://vindex.f.frappe.cloud/api/resource/CRM Lead/${recordId}`, {
        method: "PUT",
        headers: {
